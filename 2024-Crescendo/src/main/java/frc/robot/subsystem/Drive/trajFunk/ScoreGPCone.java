...
/**
 * This ATrajFunction places the game piece on th
 * e grid at the level passed.
 * It raises the arm to the level moves back to grid, drops game piece
 * moves back and drops arm to nested position.
 */
public class ScoreGPCone extends ATrajFunction {
    ...
    public void execute() {
        ...
        case 2: // Raise forearm, preload.  Wait to settle
            ...
            Arm.stepSelected = 2;
            if(trajTmr.hasExpired(3.0, state)) state++;
            break;
        ...
        case 4: // Move back on hdgHold for 0.2 Sec - Timed Move
            ...
            if(trajTmr.hasExpired(1.0, state)) state++;
            break;
