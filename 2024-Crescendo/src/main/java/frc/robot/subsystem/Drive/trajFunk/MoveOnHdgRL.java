...
/**
 * This ATrajFunction moves the robot in robot oriented mode using just the rlSpd control. rotSpd is
 * controlled by setting hdgHold. Then it moves right/left for the distance passed.
 */
