...
/**
 * This ATrajFunction moves the robot in robot oriented mode using just the fwdSpd & rlSpd control.
 * rotSpd is controlled by setting hdgHold. Then it moves either fwd/back OR left/right for the
 * distance passed.
 */
