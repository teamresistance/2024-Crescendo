...
public class Drv_Teleop extends Drive {
   ...
   *
   * <p>Check sdb chooser if changed and update. Can chg from btn or chooser.
   *
   * <p>Then set fwdSpd, rlSpd & rotSpd from JS's then apply scaling
   *
   ...
   *
   * <p>Finally, buttons to reset robot gyro, encoders & pose. Also hold a robot heading of 0
   * degrees.
   */
  ...
  public static void sdbUpdate() {
    ...
    Logger.recordOutput("Drv/Tele/wkg scale", getWkgScale());
