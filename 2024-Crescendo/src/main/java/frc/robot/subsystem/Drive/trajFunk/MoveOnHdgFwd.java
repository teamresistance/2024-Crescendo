 ...
 * the fwdSpd control.  rotSpd is controlled by setting hdgHold.
 * Then it moves either fwd/back for the distance passed.
 */
public class MoveOnHdgFwd extends ATrajFunction {
     ...
     */
    public MoveOnHdgFwd(double eHdg, double eDist, double eFwdPwr) {
        hdgSP = eHdg;
        distSP = eDist;
