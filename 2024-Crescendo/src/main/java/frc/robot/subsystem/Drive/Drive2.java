...
public class Drive2 {
    ...
    //PIDS
    private static PIDXController pidControllerX = new PIDXController(1.0/2, 0.0, 0.0); //JS X responce
    private static PIDXController pidControllerY = new PIDXController(1.0/2, 0.0, 0.0); //JS Y responce
    private static PIDXController pidControllerZ = new PIDXController(1.0/250, 0.0, 0.0);//JS Z responce
    ...
    public static void init() {
        ...
        PIDXController.setExt(pidControllerX, 0.0, 1.0/2,  0.5, 0.1, 1.0, 1.0, true); //JS X responce
        PIDXController.setExt(pidControllerY, 0.0, 1.0/2,  0.5, 0.1, 1.0, 1.0, true); //JS Y responce
        PIDXController.setExt(pidControllerZ, 0.0, 1.0/60, 1.0, 0.1, 1.0, 1.0, true); //JS Z responce
        ...
        var visionMeasurementStdDevs = VecBuilder.fill(0.1, 0.1, 0.1);
