 ...
 *
 * <p>To Climb btnClimberTgl is pressed to raise the climber vertical then extend the climber
...
public class Climber {
  ...
  private static void sdbUpdate() {
    ...
    Logger.recordOutput("Climber/Arm Vert FB", climberVert_FB);
    Logger.recordOutput("Climber/Ext 1 SV", climberExt1SV.get());
    Logger.recordOutput("Climber/Ret 1 SV", climberRet1SV.get());
