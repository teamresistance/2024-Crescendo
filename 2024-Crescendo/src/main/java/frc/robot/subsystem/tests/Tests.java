...
/**
 * Class used to select which test to run without having to reload. Sets up a chooser that is used
 * by Robot.java testInit & testPeriodic.
 */
public class Tests {
  // Hdw definition:
  // none
  ...
  /** Initialize Tests chooser stuff. Called from testInit (maybe robotInit(?)) in Robot.java */
  public static void init() {}

  /**
   * Update Test choices. Called from testPeriodic in robot.java.
   *
   * <p>Must be called from test to update testSel, an enum, KTest.
   */
