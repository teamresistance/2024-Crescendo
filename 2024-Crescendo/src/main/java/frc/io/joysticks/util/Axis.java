...
public class Axis{
	...
	/**
	 * Construct a new joystick axis object.  Needs initialized.
	 * Will return 0.0 as default.
	 */
	public Axis() {
		this.exists = false;
		this.exDefault = 0.0;
	...
	/**
	 * Construct a new joystick axis object.  Needs initialized but set default
	 * value to be return.
	...
	/**
	 * @return the rawGet modified with DB, interpolated between DB & 1.0 to outMn & Mx, 
	 * is Clamped to the Mn & Mx values if set and had an app applied:
	 * 0=linear, 1=sqrt, 2=sqrd.
	...
	public void setJS(double axInDB, double axOutMn, double axOutMx, int axApp){
		axisInDB = axInDB; axisOutMn = axOutMn; axisOutMx = axOutMx; axisApp = axApp;
	}

	public void setInDB(double axInDB){axisInDB = axInDB;}
	public void setOutMn(double axOutMn){axisOutMn = axOutMn;}
	public void setOutMx(double axOutMx){axisOutMx = axOutMx;}
	public void setApp(int axApp){axisApp = axApp;}
