 ...
 * <p>
 * Class to read a digital input. This class will read digital inputs 
 * and return the current value on the channel. Other devices such as encoders, 
...
public class DigitalInput extends edu.wpi.first.wpilibj.DigitalInput {
    ...
    /**
     * Constructor - Create an instance of a Digital Input class. Creates a digital input given a channel.
     ...
     */
    @Override
    public boolean get() {return (isInverted ^ super.get());}

    /**
     * @return the raw value of the DI without isInverted.
     */
    public boolean getRaw(){ return super.get(); }

    /**
     * @param invert set isInerted if you want the raw status inverted.
     */
    public void setIsInverted(boolean invert){ isInverted = invert; }
     ...
     */
    public boolean isDeactive() { return !get(); }	
